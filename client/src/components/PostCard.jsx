...
export default function PostCard({post}) {
  return (
    <div className="group relative w-full border h-[350px] border-teal-500 hover:border-2 overflow-hidden rounded-lg sm:w-[430px] transition-all ">
        <Link to={`/post/${post.slug}`}>
            <img className="'h-[230px] w-full object-cover group-hover:h-[170px] transition-all duration-300 z-20" src={post.image}/>
        </Link>
